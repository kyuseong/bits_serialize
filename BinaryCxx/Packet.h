...
struct NumBitsInclusive
{
	enum { Count = (NumBitsInclusive<NUMBER / 2>::Count + 1) };
};

template<>
struct NumBitsInclusive<0>
{
	enum { Count = 0 };
};

template<>
struct NumBitsInclusive<1>
{
	enum { Count = 1 };
};
...
struct NumBits
{
	enum { Count = (NumBitsInclusive<NUMBER - 1>::Count) };
};
